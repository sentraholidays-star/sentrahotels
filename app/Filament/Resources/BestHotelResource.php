...
use App\Filament\Resources\BestHotelResource\Pages;
use App\Filament\Resources\BestHotelResource\RelationManagers;
...
class BestHotelResource extends Resource
{
    protected static ?string $model = BestHotel::class;

    protected static ?string $navigationIcon = 'heroicon-o-trophy';
    protected static ?string $navigationGroup = 'Tampilan Depan';
    protected static ?string $navigationLabel = 'Best Hotels';
    ...
    {
        return [
            'index' => Pages\ListBestHotels::route('/'),
            'create' => Pages\CreateBestHotel::route('/create'),
            'edit' => Pages\EditBestHotel::route('/{record}/edit'),
        ];
    }
}
