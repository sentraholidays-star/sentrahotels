...
@section('title', 'Hotel Brands Promo - Sentra Hotels')
...
<section class="relative bg-slate-900 w-full h-[60vh] min-h-[400px]">
    @php
        $banners = $settings->hotel_brand_promo_banners ?? [];
            ...
            <div class="swiper-wrapper">
                @foreach($banners as $mediaId)
                    ...
                    <div class="swiper-slide w-full h-full relative">
                        <img src="{{ $media->url }}" class="w-full h-full object-cover object-center" alt="Banner Hotel Brands Promo">
                ...
                @foreach($hotelBrands as $rate)
                    ...
                    <div class="bg-white rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 overflow-hidden">
                        ...
                        <div class="w-full aspect-[4/3] bg-slate-200 relative overflow-hidden group">
                            ...
                            <img src="{{ $imgUrl }}" alt="{{ $rate->brand_name }}" class="w-full h-full object-cover transition-transform duration-700">
                        </div>
                        ...
                        <div class="p-5">
                            ...
                            <!-- Nama Hotel -->
                            <h3 class="text-lg font-bold text-slate-900 mb-1 line-clamp-1" title="{{ $rate->brand_name }}">{{ $rate->brand_name }}</h3>
