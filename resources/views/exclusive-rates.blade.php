...
@section('title', 'Exclusive Rates - Sentra Hotels')
@section('meta_description', 'Temukan penawaran eksklusif terbaik dari Sentra Hotels.')

@php
    $banners = $settings->hotel_promo_banners ?? [];
            ...
            <div class="swiper-wrapper">
                @foreach($banners as $mediaId)
                    ...
                    <div class="swiper-slide w-full h-full relative">
                        <img src="{{ $media->url }}" class="w-full h-full object-cover object-center" alt="Banner Exclusive Rates">
...
<section class="py-12 bg-slate-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <!-- HOTEL CARDS GRID -->
        @if($hotelPromos->count() > 0)
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach($hotelPromos as $rate)
